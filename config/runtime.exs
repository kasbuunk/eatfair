...
#
#     PHX_SERVER=true bin/eatfair start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :eatfair, EatfairWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  database_path =
    System.get_env("DATABASE_PATH") ||
      ...
      For example: /etc/eatfair/eatfair.db
      """

  config :eatfair, Eatfair.Repo,
  ...
  config :eatfair, :google_maps, api_key: google_maps_api_key
