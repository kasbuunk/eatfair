# Phoenix/Elixir Technical Reference

This document contains detailed technical guidelines for Phoenix and Elixir development. These guidelines should be followed by all developer agents when implementing features.
