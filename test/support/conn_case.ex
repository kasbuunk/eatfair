defmodule EatfairWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use EatfairWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      import EatfairWeb.ConnCase
    end
  end

  setup tags do
    Eatfair.DataCase.setup_sandbox(tags)
  ...
  def register_and_log_in_user(%{conn: conn} = context) do
    ...
    scope = Eatfair.Accounts.Scope.for_user(user)
  ...
  def log_in_user(conn, user, opts \\ []) do
    token = Eatfair.Accounts.generate_user_session_token(user)
