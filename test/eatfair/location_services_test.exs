defmodule Eatfair.LocationServicesTest do
    ...
    test "handles unknown locations gracefully" do
      ...
      for location <- unknown_locations do
        ...
        case result do
          ...
          {:error, :not_found} -> :ok
          # Google may return a general location
          {:ok, geocoded} when is_map(geocoded) -> :ok
        end
      end
    end
  ...
  describe "address normalization" do
    test "enhances Dutch addresses correctly" do
      ...
      test_cases = [
        # Postal code should be enhanced
        {"1012 AB", true},
        # Postal code without space should be enhanced  
        {"1012AB", true},
        # City should be enhanced
        {"Utrecht", true},
        # Already has country
        {"Amsterdam, Netherlands", false},
        # Already has Dutch country name
        {"Utrecht, Nederland", false}
      ]
