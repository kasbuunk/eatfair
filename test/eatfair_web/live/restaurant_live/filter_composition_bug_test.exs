    ...
    setup do
      ...
      laren_restaurant =
        restaurant_fixture(%{
          ...
          latitude: Decimal.new("52.2576"),  # Near Bussum
      ...
      london_restaurant =
        restaurant_fixture(%{
          ...
          latitude: Decimal.new("51.5074"),  # Far from Bussum
      ...
      amsterdam_restaurant =
        restaurant_fixture(%{
          ...
          latitude: Decimal.new("52.3702"),  # Far from Bussum but closer than London
