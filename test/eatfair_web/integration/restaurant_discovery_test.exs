defmodule EatfairWeb.Integration.RestaurantDiscoveryTest do
  ...
  describe "🗺️ Address Management for Location-Based Search" do
    ...
    test "📍 customer can set default address for restaurant discovery", %{
      conn: conn,
      customer: customer
    } do
      conn = log_in_user(conn, customer)
  ...
  describe "🧭 Distance-Based Delivery Validation" do
    setup do
      customer =
        confirmed_user_fixture(%{
          # Central Amsterdam
          default_address: "Damrak 1, Amsterdam"
        })
      ...
      far_restaurant =
        restaurant_fixture(%{
          name: "Far Restaurant",
          # ~5km from Damrak
          address: "Amstelpark 1, Amsterdam",
          latitude: Decimal.new("52.3400"),
          longitude: Decimal.new("4.8900"),
          # Too small to reach customer
