defmodule EatfairWeb.UserAuth do
  use EatfairWeb, :verified_routes
  ...
  @remember_me_cookie "_eatfair_web_user_remember_me"
  @remember_me_options [
    sign: true,
  ...
  def disconnect_sessions(tokens) do
    Enum.each(tokens, fn %{token: token} ->
      EatfairWeb.Endpoint.broadcast(user_session_topic(token), "disconnect", %{})
    end)
  end
  ...
  the `current_scope`:
      ...
      defmodule EatfairWeb.PageLive do
        use EatfairWeb, :live_view

        on_mount {EatfairWeb.UserAuth, :mount_current_scope}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{EatfairWeb.UserAuth, :require_authenticated}] do
