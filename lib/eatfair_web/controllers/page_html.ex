    ...
    <a href="#" class="group block">
      <div class="relative overflow-hidden rounded-lg shadow-lg transition-transform duration-300 group-hover:scale-105">
        <img
          ...
          onerror="this.onerror=null;this.src='https://placehold.co/300x200/cccccc/FFFFFF?text=Image+Not+Found';"
        />
        ...
        <div class="flex items-baseline justify-between">
          ...
          <div class="ml-2 flex items-center rounded-full bg-orange-100 px-2 py-1 text-xs font-semibold text-orange-600">
            ...
            >
              <path
                fill-rule="evenodd"
                d="M10.868 2.884c.321-.662 1.215-.662 1.536 0l1.681 3.46c.154.318.46.533.806.578l3.81.553c.73.106 1.023.998.494 1.503l-2.758 2.688a.996.996 0 00-.287.885l.65 3.794c.125.726-.635 1.28-1.29.942l-3.402-1.789a.997.997 0 00-.92 0l-3.402 1.789c-.655.338-1.415-.216-1.29-.942l.65-3.794a.996.996 0 00-.287-.885L2.32 9.08c-.53-.505-.237-1.397.494-1.503l3.81-.553a.997.997 0 00.806-.578L9.132 2.884z"
                clip-rule="evenodd"
              />
            </svg>
            {@rating}
