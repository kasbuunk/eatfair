defmodule Eatfair.GeoUtils do
  ...
  """
  def within_delivery_range?(restaurant_lat, restaurant_lon, customer_lat, customer_lon, delivery_radius_km) do
    distance = case {restaurant_lat, restaurant_lon, customer_lat, customer_lon} do
